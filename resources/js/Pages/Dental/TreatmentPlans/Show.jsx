...
function NewItemForm({ patientId, planId, serviceCatalogItems, permanentTeeth, deciduousTeeth }) {
    ...
    return (
        <form onSubmit={submit} className="rounded-md border border-dashed border-gray-300 bg-gray-50 p-3">
            <h4 className="mb-2 text-sm font-semibold text-ink-secondary">Nuova voce</h4>
            <div className="flex flex-wrap items-start gap-3">
                <div className="min-w-[12rem] flex-1">
                    <InputLabel value="Prestazione" />
                    <select
            ...
            <div className="py-16">
                <div className="mx-auto max-w-4xl space-y-6 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white p-8 shadow-soft sm:rounded-card">
                        <h3 className="mb-4 text-lg font-medium text-ink">Voci del piano</h3>
                        {canManage ? (
                    ...
                    <div className="bg-white p-8 shadow-soft sm:rounded-card">
                        <div className="mb-4 flex items-center justify-between">
                            <h3 className="text-lg font-medium text-ink">Preventivi generati</h3>
                            {canGenerateQuote && (
                        ...
                        <ul className="space-y-2 text-sm">
                            {quotes.map((quote) => (
                                <li key={quote.id} className="flex items-center justify-between border-b border-gray-100 pb-2">
                                    <Link href={route('quotes.show', quote.id)} className="text-brand hover:underline">
